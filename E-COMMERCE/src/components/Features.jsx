  ...
  return (
    <div className="flex flex-col items-center justify-center mt-16">
      ...
      <div className="flex flex-col md:flex-row justify-around items-center mt-12 w-full px-4 md:px-16">
        ...
        <FontAwesomeIcon icon={faBookOpenReader } className="h-12 w-12 text-blue-500 mb-4" />
          <h3 className="text-xl font-bold">Easy Wins</h3>
          <p className="text-gray-600 mt-2">Get your best looking smile now!</p>
        </div>
        <div className="flex flex-col items-center text-center mb-8 md:mb-0">
        <img src={GridIcon} className="h-12 w-12 text-blue-500 mb-4" />
        ...
        <div className="flex flex-col items-center text-center mb-8 md:mb-0">
        <FontAwesomeIcon icon={faArrowTrendUp} className="h-12 w-12 text-blue-500 mb-4" />
