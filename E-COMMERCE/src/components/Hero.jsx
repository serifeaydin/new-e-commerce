        ...
        >
          ...
          <SwiperSlide>
            <div className="relative">
              ...
              <div className="absolute top-1/3 md:top-1/2 lg:top-1/3 left-1/2 transform -translate-x-1/2 md:translate-x-0 text-white text-center md:text-left p-4 md:p-8">
                ...
                <Link to="/shop">
                  <button className="px-8 py-4 bg-[#23A6F0] text-white font-bold text-xl">Start Now</button>
                </Link>
              </div>
            </div>
          </SwiperSlide>
